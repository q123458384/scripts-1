...
[task_local]
#获取互助码并格式化
55 23 * * * https://cdn.jsdelivr.net/gh/Hydrahail-Johnson/scripts@main/js/getShareCode_format.js, tag=获取互助码并格式化, enabled=true
===========Loon============
[Script]
cron "55 23 * * *" script-path=https://cdn.jsdelivr.net/gh/Hydrahail-Johnson/scripts@main/js/getShareCode_format.js,tag=店铺签到
============Surge=============
获取互助码并格式化 = type=cron,cronexp="55 23 * * *",wake-system=1,timeout=3600,script-path=https://cdn.jsdelivr.net/gh/Hydrahail-Johnson/scripts@main/js/getShareCode_format.js
===========小火箭========
获取互助码并格式化 = type=cron,script-path=https://cdn.jsdelivr.net/gh/Hydrahail-Johnson/scripts@main/js/getShareCode_format.js, cronexpr="55 23 * * *", timeout=3600, enable=true
 */
